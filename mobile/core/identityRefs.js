...
export const IDENTITY_SLOTS = [
  {
    ...
    blurb: 'Four full-body views: front, side, back and three-quarter.',
    aspectRatio: '16:9',
  ...
  },
  {
    ...
    label: 'Close-up',
    blurb: 'A straight-on studio headshot that keeps the face consistent.',
    aspectRatio: '4:5',
  ...
  },
  {
    ...
    label: 'Feature sheet',
    blurb: 'Close detail of the eyes, brows, lips, skin, hair and hands.',
    aspectRatio: '2:3',
