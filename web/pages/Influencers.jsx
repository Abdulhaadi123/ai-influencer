...
import { useInfluencers, useBrandDeals, generateId } from '../../mobile/core/store'
import ImageGrid from '../components/ImageGrid'
import MasonryGrid from '../components/MasonryGrid'
import Lightbox from '../components/Lightbox'
import { compressImage, downloadImage } from '../../mobile/core/platform/media'
import { generateSingleImage, generateThreeImages, generateVideo, initSession, pollAllJobs, getPendingGens, clearPendingGen, getPendingVideo, clearPendingVideo, resumeVideoJob } from '../../mobile/core/services/generation'
import { buildThreeVariationPrompts } from '../../mobile/core/prompts/systemPrompt'
...
import { buildCharSheetPrompt, buildCharSheetPromptWithClaude } from '../../mobile/core/prompts/charSheetPrompt'
...
function ContentStudio({ influencer, onUpdate, onSaveToScripts, onGenerated, restoreKey = 0, pendingStartFrame = null, onStartFrameConsumed }) {
  ...
  const videoModel = 'kling-3.0/video'
  ...
  function buildPrompt() {
    return buildVideoPrompt(influencer, {
      productRef1, productRef2, productRef3, productWorn,
      startFrameUrl, selectedWardrobe, selectedHome,
      shotMode, duration, camera,
      videoTimeOfDay, environment, envKey, vibe,
      dialogue, additionalNotes,
      audioDataUrl, voicePreset, voiceCustom,
    })
  }
  ...
  function buildRefs() {
    return [
      influencer.mainImage,
      productRef1 || selectedWardrobe?.image || influencer.characterSheetImage,
